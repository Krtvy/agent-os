-- Provenance: _private/daily_reporting/main.py · def sql_video_lives_trend(d: dict)
-- Purpose:    Per-day count of videos and livestreams that produced orders, last N days.
...
WHERE (t.created_time - INTERVAL '8 hours') >= '{d["thirty_day_start"]}'
...
GROUP BY DATE((t.created_time - INTERVAL '8 hours'))
ORDER BY d
